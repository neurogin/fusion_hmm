# Step 21 Brainstorm Volume Source And Atlas Import Manual
...
1. run `step22_extract_volgrid_scouts_from_brainstorm_tess.m`
2. run `step23_export_eeg_parcel_pc1_and_gain_normalize.m`
3. run `step24_qc_eeg_source_alignment_table_s2.m`
4. run `step25_generate_eeg_parcel_export_qc_sidecars.m`
5. open `step26_qc_eeg_parcel_exports_table_s3_and_figures_s2_s4.ipynb`
