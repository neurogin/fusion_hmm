...
% Clean, alignment-safe run-level QC gates for R01 rerun.
% Run-level include/exclude gates for R01 rerun.
%
% Primary inputs:
%   - Cleaned EEGLAB sets: <eeg_ic_pruned_dir>\clean\*_desc-<TAG>_clean.set
...
if N_kept <= 1
    ...
    adj_pairs = sum(max(0, lens_samp - 1)); % Σ(L−1)
