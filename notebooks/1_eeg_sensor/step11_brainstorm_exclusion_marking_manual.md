# Step 11 Brainstorm Exclusion Marking Manual

## What This File Is

This is the manual or hybrid stage that sits between the two scripted Stage-1 entry files:
...
- Run `step10_eeg_prune_iclabel_and_export_clean_sets.m` first so the clean `*_clean.set` files already exist.
...
This repository keeps Brainstorm exclusion marking explicit as a manual or hybrid dependency on purpose.
